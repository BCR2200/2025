...
public class Left4Piece extends AutoCommand {
  ...
  public Left4Piece(RobotContainer robot, ElevClArmSubsystem e, CommandSwerveDrivetrain drivetrain, SwerveRequest.RobotCentric swerve) {
    ...
    addCommands(
        ...
        new PathAndElevateWithinDist(path3, ReefSide.FL, SnapButton.Left, 2.5, RequestState.CoralLevel4, e),
        ...
        new PathAndElevateWithinDist(path5, ReefSide.FL, SnapButton.Right, 2.5, RequestState.CoralLevel4, e),
