...
public class TautoRB extends AutoCommand {
  ...
  public TautoRB(RobotContainer robot, ElevClArmSubsystem e, CommandSwerveDrivetrain drivetrain, SwerveRequest.RobotCentric swerve) {
    path1L = AutoBuildingBlocks.loadPathOrThrow("TautoRB.1L");
    path1R = AutoBuildingBlocks.loadPathOrThrow("TautoRB.1R");
    path2L = AutoBuildingBlocks.loadPathOrThrow("TautoRB.2L");
    path2R = AutoBuildingBlocks.loadPathOrThrow("TautoRB.2R");
    addCommands(
        // is auto step the problem??
        new WaitForCoralCmd(e),

        AutoBuildingBlocks.autoStep("PATH 1"),
        new PathAndElevateWithinDist(path1L, ReefSide.BR, SnapButton.Left, 1.5, RequestState.CoralLevel3, e),
        ...
        new PathAndElevateWithinDist(path1R, ReefSide.BR, SnapButton.Right, 1.5, RequestState.CoralLevel3, e),
        ...
        new PathAndElevateWithinDist(path1L, ReefSide.BR, SnapButton.Left, 1.5, RequestState.CoralLevel2, e),
        AutoBuildingBlocks.autoStep("SCORE L3 Left FL"),
        ...
        AutoBuildingBlocks.autoStep("PATH 1R"),
        new PathAndElevateWithinDist(path1R, ReefSide.BR, SnapButton.Right, 1.5, RequestState.CoralLevel2, e),
        AutoBuildingBlocks.autoStep("SCORE L3 RIGHT FL"),
