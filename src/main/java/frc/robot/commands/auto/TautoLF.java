...
public class TautoLF extends AutoCommand {
  ...
  public TautoLF(RobotContainer robot, ElevClArmSubsystem e, CommandSwerveDrivetrain drivetrain, SwerveRequest.RobotCentric swerve) {
    path1L = AutoBuildingBlocks.loadPathOrThrow("TautoLF.1L");
    path1R = AutoBuildingBlocks.loadPathOrThrow("TautoLF.1R");
    path2L = AutoBuildingBlocks.loadPathOrThrow("TautoLF.2L");
    ...
    addCommands(
        ...
        new LimelightAutoCmd(robot, ReefSide.FL, e, drivetrain, SnapButton.Left, RequestState.CoralLevel3, swerve, 2),
        ...
        new PathAndElevateWithinDist(path1R, ReefSide.FL, SnapButton.Right, 1.5, RequestState.CoralLevel3, e),
        AutoBuildingBlocks.autoStep("SCORE L3 RIGHT FL"),
        new LimelightAutoCmd(robot, ReefSide.FL, e, drivetrain, SnapButton.Right, RequestState.CoralLevel3, swerve, 2),
        AutoBuildingBlocks.autoStep("Return to Feeder"),
        ...
        new PathAndElevateWithinDist(path1L, ReefSide.FL, SnapButton.Left, 1.5, RequestState.CoralLevel2, e),
        AutoBuildingBlocks.autoStep("SCORE L3 Left FL"),
        new LimelightAutoCmd(robot, ReefSide.FL, e, drivetrain, SnapButton.Left, RequestState.CoralLevel2, swerve, 2),
        AutoBuildingBlocks.autoStep("Return to Feeder"),
        AutoBuildingBlocks.followPathCommand(path2L),
        ...
        AutoBuildingBlocks.autoStep("PATH 1R"),
        new PathAndElevateWithinDist(path1R, ReefSide.FL, SnapButton.Right, 1.5, RequestState.CoralLevel2, e),
        AutoBuildingBlocks.autoStep("SCORE L3 RIGHT FL"),
        new LimelightAutoCmd(robot, ReefSide.FL, e, drivetrain, SnapButton.Right, RequestState.CoralLevel2, swerve, 2),
        AutoBuildingBlocks.autoStep("Return to Feeder"),
        AutoBuildingBlocks.followPathCommand(path2R)
    );
  }
